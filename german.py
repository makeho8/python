...
df_german = pd.read_csv('http://archive.ics.uci.edu/ml/machine-learning-databases/statlog/german/german.data-numeric')
...
### S_TWSVM best params of S_TWSVM {'c1': 1.0, 'c2': 0.0001, 'c3': 10.0}
from S_TWSVM_class import S_TWSVM
start_time = time.time()
clf3 = S_TWSVM(c1 = 1, c2 = 0.0001, c3 = 10)
