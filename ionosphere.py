...
df_ionosphere = pd.read_csv('http://archive.ics.uci.edu/ml/machine-learning-databases/ionosphere/ionosphere.data')
...
###WS_SVM best params of WS_SVM {'c1': 0.0001, 'c2': 0.1, 'c3': 0.0001}
from WS_SVM_class import WS_SVM
start_time = time.time()
clf2 = WS_SVM(c1 = 0.0001, c2 = 0.1, c3 = 0.0001)
...
### S_TWSVM best params of S_TWSVM {'c1': 0.01, 'c2': 0.1, 'c3': 100.0}
from S_TWSVM_class import S_TWSVM
start_time = time.time()
clf3 = S_TWSVM(c1 = 0.01, c2 = 0.1, c3 = 100)
...
# TWSVM best params of TWSVM {'c': 0.01, 'c_': 0.01}
from TWSVM_class import TWSVM
start_time = time.time()
clf4 = TWSVM(c = 0.01, c_ = 0.01)
