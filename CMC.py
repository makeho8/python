...
df_cmc = pd.read_csv('http://archive.ics.uci.edu/ml/machine-learning-databases/cmc/cmc.data', header = None)
...
print('class labels', np.unique(df_cmc['Contraceptive method used']))
...
###WS_SVM best params of WS_SVM {'c1': 0.0001, 'c2': 1.0, 'c3': 10.0}
from WS_SVM_class import WS_SVM
start_time = time.time()
clf2 = WS_SVM(c1 = 0.0001, c2 = 1, c3 = 10)
