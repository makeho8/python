...
df_heart_statlog = pd.read_csv('http://archive.ics.uci.edu/ml/machine-learning-databases/statlog/heart/heart.dat', header = None)

#df_heart_statlog.columns = ['age','sex','chest pain type','resting blood pressure','serum cholesterol in mg/dl',
...
#                            'thal: 3 = normal; 6 = fixed defect; 7 = reversable defect','predicted']
