...
df_au = pd.read_csv('http://archive.ics.uci.edu/ml/machine-learning-databases/statlog/australian/australian.dat')
...
###WS_SVM best params of WS_SVM {'c1': 0.0001, 'c2': 0.001, 'c3': 0.0001}
from WS_SVM_class import WS_SVM
start_time = time.time()
clf2 = WS_SVM(c1 = 0.0001, c2 = 0.001, c3 = 0.0001)
...
### S_TWSVM best params of S_TWSVM {'c1': 10.0, 'c2': 1.0, 'c3': 100.0}
from S_TWSVM_class import S_TWSVM
start_time = time.time()
clf3 = S_TWSVM(c1 = 10, c2 = 1, c3 = 100)
